      ...
      <div class="panel-body">
          <div class="row">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>Lần thi</th>
                        <td>Lần {{ $contest_result->number_current_contest_round($contest_result->subject->id, App\User::find($contest_result->user_id)) }}</td>
                    </tr>
                    <tr>
                        <th>Kết quả</th>
                            ...
                            <div class="panel-body title_question_option">
                                @foreach($question->question_options as $qt)
                                    {{-- <div class="col col-md-6"> --}}
                                        <div class="radio {{ $qt->correct == 1 ? 'radio-true' : '' }} ">
